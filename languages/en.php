...
%s",
  ...
  'questions:workflow:intanswer' => 'internal answer',
  ...
  'questions:workflow:claim' => 'This question is not claimed yet. Do you want to claim the question?',
  'questions:workflow:claim:yes' => 'Claim question',
  'questions:workflow:claim:success' => 'Question claim succesful',
  'questions:workflow:claim:failed' => 'Question claim failed',
  'questions:workflow:alreadyclaimed' => 'This question is claimed already by another user',
  ...
  'questions:workflow:switch:overview' => 'Overview',
  ...
  'questions:workflow:filter:all' => 'All',
  'questions:workflow:filter:open' => 'Open',
  'questions:workflow:filter:closed_check' => 'Closed (active)',
  'questions:workflow:filter:closed_no_check' => 'Closed (inactive)',
