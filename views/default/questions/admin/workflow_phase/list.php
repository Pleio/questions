...
<div class="elgg-module elgg-module-inline">
  ...
  <br /><?php echo elgg_view("output/url", array("text" => elgg_echo("add"), "href" => $vars["url"] . "questions/admin/forms/phase_field", "class" => "elgg-button elgg-button-action questions-popup"));?>
</div>